...
class CommissionController extends Controller
{
    ...
    public function commissions_users($partner_id){
        ...
        if ($commissions_users==1){
            $commissions_users_data = Commission::select(array('amp','personal_discount','personal_discount_history','amp_history','simulation_1_level','simulation_2_level'))
    ...
    public function commissions_users_optimizado($partner_id){
        $period = date("Y-m");
    ...
    public function commissions_users_2($partner_id){
        ...
        if ($commissions_users_2==1){
            ...
            if(isset($commissions_users_data['amp'])) {
